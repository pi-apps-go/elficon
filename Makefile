...
pkgdatadir = $(datadir)/elfres
pkgincludedir = $(includedir)/elfres
pkglibdir = $(libdir)/elfres
pkglibexecdir = $(libexecdir)/elfres
...
CYGPATH_W = echo
DEBEXTRA = 
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DPACKAGE=\"elfres\" -DVERSION=\"0.6.0\" -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DENABLE_NLS=1 -DHAVE_GETTEXT=1 -DHAVE_DCGETTEXT=1 -DHAVE_DLFCN_H=1 -DLT_OBJDIR=\".libs/\" -DUSE_GTKBUILDER=1
DEPDIR = .deps
DLLTOOL = false
DSYMUTIL = 
DUMPBIN = 
...
# Pass the update request up to the i18n makefile
update-po:
